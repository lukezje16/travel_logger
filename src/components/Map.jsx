...
function Map() {
  ...
  //used to update the map position whenever the two variables are changed
  useEffect(
    function () {
...
function DetectClick() {
  //detects the click then uses a custome hook form the library
  //to store the event data into the url as global state
